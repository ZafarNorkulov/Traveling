...
const Reviews = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-12 gap-[50px]">
        ...
        <div className="review-card col-span-4 p-6 bg-white rounded-[20px] max-h-[584px]" key={index}>
    <h4 className='text-2xl font-bold font-TradeGothic'>{item?.title}</h4>
    ...
    <Image src={item?.img} className='h-[200px]' alt=''/>
        </div>
        ))}
    </div>
    </div>
