  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-12 bg-white rounded-3xl shadow-md p-6 gap-6 ">
        ...
        <div className="lg:col-span-4 sm:col-span-6 col-span-10 border-dashed hover:bg-[#effdf9ad] border-2 h-[212px] rounded-2xl border- border-[#8dd3bb] flex flex-col justify-center items-center" onClick={()=>setOpenModalStatus(true)}>
        ...
        <div className="py-11 px-10">
          ...
          <Form className="grid grid-cols-12 gap-6 mt-12">
            <FieldSetComponent title="Card Number" className="col-span-12">
              <InputNumber className="w-full"  bordered={false}/>
            </FieldSetComponent>
